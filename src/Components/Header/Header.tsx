...
import { ContainerHeader, ContainerImg, ContainerText, Imgqrcode, Imgportal } from "./styleH";

const Header = () => {
  return (
    <ContainerHeader>
      <ContainerImg>
        <Imgportal src={portal} alt=""  />
      </ContainerImg>
      <hr />
      ...
      <ContainerText>
        ...
        <a href="https://www1.unicap.br/TurmasDisciplinas/html/index.html">https://www1.unicap.br/TurmasDisciplinas/html</a>
        <Imgqrcode src={Edu} alt="as" width="500px"  />
      </ContainerText>
    </ContainerHeader>
  );
};
